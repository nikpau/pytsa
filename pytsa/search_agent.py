...
class SearchAgent:
    """
    The SearchAgent objects searches through a user-provided
    ais data set and serves two purposes:
        1. Extract all trajectories from the raw data set and
        sort them into `TargetVessel` objects. Each TargetVessel
        represents a single ship and contains data about its
        MMSI, dimension and trajectory.
    ...
    def __init__(
        ...
        msg5file: path to a list of .csv files contraining static voyage data
                    (Message type 5)
